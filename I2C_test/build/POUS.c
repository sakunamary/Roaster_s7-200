...
void PROGRAM0_init__(PROGRAM0 *data__, BOOL retain) {
  __INIT_VAR(data__->T0,0,retain)
  __INIT_VAR(data__->ADD_SLAVE,67,retain)
  __INIT_VAR(data__->SCK_PIN,22,retain)
  __INIT_VAR(data__->SDA_PIN,21,retain)
  I2C_THREMO_4_OUT_init__(&data__->I2C_THREMO_4_OUT0,retain);
}
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->I2C_THREMO_4_OUT0.,ADDR_SLAVE,,__GET_VAR(data__->ADD_SLAVE,));
  __SET_VAR(data__->I2C_THREMO_4_OUT0.,SCK_PIN,,__GET_VAR(data__->SCK_PIN,));
  __SET_VAR(data__->I2C_THREMO_4_OUT0.,SDA_PIN,,__GET_VAR(data__->SDA_PIN,));
  I2C_THREMO_4_OUT_body__(&data__->I2C_THREMO_4_OUT0);
  __SET_VAR(data__->,T0,,__GET_VAR(data__->I2C_THREMO_4_OUT0.OUT_0,));
