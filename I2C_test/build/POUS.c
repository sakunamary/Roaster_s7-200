...
void GET_TEMP_init__(GET_TEMP *data__, BOOL retain) {
  I2C_AHT20_init__(&data__->I2C_AHT200,retain);
...
// Code part
void GET_TEMP_body__(GET_TEMP *data__) {
  // Initialise TEMP variables

  __SET_VAR(data__->I2C_AHT200.,EN,,__BOOL_LITERAL(TRUE));
  __SET_VAR(data__->I2C_AHT200.,SCK_PIN,,__GET_VAR(data__->SCK,));
  __SET_VAR(data__->I2C_AHT200.,SDA_PIN,,__GET_VAR(data__->SDA,));
